...
async function GlaskogencardBuy (props) {
  ...
  html`
    ...
    <p>Du kan skanna QR-koden med din Swish-app på datorn, eller klicka på knappen för att öppna Swish på mobilen!</p>
    ...
    <swish-button amount="40" message="Glaskogenkort. Dag." payee="" qr-code="img/dagskort.svg"></swish-button>

    <h3>Dygnskort</h3>
    <p>För dig som skall övernatta i Glaskogen. Tillåter dig att nyttja ved, vindskydd och stugor.</p>
    <span>60 kr per person</span>
    <a id="night"></a>
    <swish-button amount="60" message="Glaskogenkort. Dygn." payee="" qr-code="img/dygnskort.svg"></swish-button>

    <h3>Årskort</h3>
    <p>Samma befogenheter som dygnskort men gäller för ett helt år.</p>
    <span>800 kr per person</span>
    <swish-button amount="800" message="Glaskogenkort. År." payee="" qr-code="img/årskort.svg"></swish-button>
    ...
    <swish-button amount="800" message="Glaskogenkort. År, familj." payee="" qr-code="img/årskort-familj.svg"></swish-button>
    ...
    <swish-button amount="80" message="Fiskekort." payee="" qr-code="img/fiskekort.svg"></swish-button>
  `;
}
